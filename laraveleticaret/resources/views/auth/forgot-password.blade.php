        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>şifremi unuttum</span></li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{route('password.email')}}">
                                    ...
                                    <fieldset class="wrap-title">
                                        <h3 class="form-title">Şifreni unuttun mu?</h3>
                                    </fieldset>
                                    ...
                                    <input type="submit" class="btn btn-submit" value="Email Hesabına Sıfırlama Linki Gönder" name="submit">
                                </form>
                            </div>
                        </div>

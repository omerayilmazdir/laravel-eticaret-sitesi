...
class UserEditProfileComp extends Component
{
    use WithFileUploads;
    public $name;
    public $email;
    ...
    public function updateProfile(){
        ...
        if($this->newimage){
            if($this->image){
                unlink('Front/assets/images/profile'.$this->image);
            }
    ...
    {
        return view('livewire.user.user-edit-profile-comp')->layout('layouts.master');
    }
}
